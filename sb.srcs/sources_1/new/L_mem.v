...
(
    ...
    output wire [0:DATA_WIDTH*BLOCK_SIZE-1] dout_i, // updated L_i
    output wire [0:DATA_WIDTH*BLOCK_SIZE-1] dout_j // updated L_j
);
...
generate
    for (gi = 0; gi < BLOCK_SIZE; gi = gi + 1) begin : gen_next_tmp_j
        ...
        assign dout_i[gi*DATA_WIDTH +: DATA_WIDTH] = L_i_new[gi];
        assign dout_j[gi*DATA_WIDTH +: DATA_WIDTH] = L_j_new[gi];
    end
endgenerate
